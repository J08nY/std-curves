  ...
  return (
    <Entry data={data} location={location} title={"KSS"}>
      ...
      <Styled.p>
        ...
        <InlineMath>{`k \\in \\{16,18,36,40\\}`}</InlineMath>. Given an integer{" "}
        <InlineMath>{`z \\in \\mathbb{N}`}</InlineMath> a KSS curve can be
        ...
        <InlineMath>t</InlineMath> as follows:
      </Styled.p>
      <Styled.h3>
        <InlineMath>k = 16</InlineMath>
      </Styled.h3>
      <BlockMath>
        {`\\begin{aligned}
      ...
      <Styled.p>
        ...
        <InlineMath>b</InlineMath> until a curve is found.
      </Styled.p>
      <Styled.p>The following SageMath code generates KSS curves.</Styled.p>
      <CodeBlock code={kssCode} language="python" />
      <Styled.h4>References</Styled.h4>
      <ul>
        <li>
          Ezekiel J. Kachisa, Edward F. Schaefer, Michael Scott:{" "}
          <Link to="https://link.springer.com/chapter/10.1007/978-3-540-85538-5_9">
            Constructing Brezing-Weng Pairing-Friendly Elliptic Curves Using
