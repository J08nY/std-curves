...
export default ({ data, location }) => {
  ...
  return (
    <Entry data={data} location={location} title={"Brainpool"}>
      ...
      <ul>
        <li>
          For each of the bit-lengths{" "}
          <InlineMath>160, 192, 224, 256, 320, 384, 512</InlineMath> one curve
          shall be proposed.
        </li>
        <li>
          The base field size <InlineMath>p</InlineMath> should be congruent to{" "}
          <InlineMath>{`3 \\mod 4`}</InlineMath>.
        </li>
        <li>
          The curve should be <InlineMath>{`\\mathbb{F}_p`}</InlineMath>
          -isomorphic to a curve with{" "}
          <InlineMath>{`A \\equiv -3 \\mod p`}</InlineMath>.
        </li>
        <li>
          The prime <InlineMath>p</InlineMath> must not be of a special form in
          order to avoid patented fast arithmetic on the base field.
        </li>
        <li>
          The order of the curve{" "}
          <InlineMath>{`\\lvert \\mathcal{E}(\\mathbb{F}_p) \\rvert`}</InlineMath>{" "}
          should be smaller than the size of the base field{" "}
          <InlineMath>p</InlineMath>.
        </li>
        <li>
          The curve coefficient <InlineMath>B</InlineMath> should be non-square
          in <InlineMath>{`\\mathbb{F}_p`}</InlineMath>.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          <InlineMath>{`l = \\min\\{t \\vert q \\text{divides} p^t - 1 \\}`}</InlineMath>{" "}
          should be large, where <InlineMath>q</InlineMath> is the order of the
          basepoint and <InlineMath>p</InlineMath> the size of the base field.
          Specifically, <InlineMath>{`(q - 1) / l < 100`}</InlineMath>.
        </li>
        <li>
          The curves are not trace one curves. Specifically{" "}
          <InlineMath>{`\\lvert \\mathcal{E}(\\mathbb{F}_p) \\rvert \\ne p`}</InlineMath>
          .
        </li>
        <li>
          The class number of the maximal order of the endomorphism ring of the
          curve is larger than <InlineMath>10000000</InlineMath>.
        </li>
        <li>
          The group order{" "}
          <InlineMath>{`\\lvert \\mathcal{E}(\\mathbb{F}_p) \\rvert`}</InlineMath>{" "}
          should be a prime number <InlineMath>q</InlineMath>.
        </li>
      </ul>
      <Styled.h3>Original method</Styled.h3>
      Brainpool published their method of generating verifiably random curves in
      the <b>ECC Brainpool Standard Curves and Curve Generation</b>{" "}
      <Link to="#brainpool-std">[1]</Link> document, along with generated domain
      parameters claimed to be generated using the presented method and seeds.
      However, the presented <Link to={"/brainpool/"}>curves</Link> were (with
      the exception of the 512-bit curves) <b>not</b> generated using the
      presented method, as they have properties that can not result from the
      presented method of generating curves. See the <b>BADA55 paper</b>{" "}
      <Link to="bada55-brainpool">[3]</Link> for more information.
      <Styled.h3>RFC 5639 method</Styled.h3>
      Brainpool published an RFC with their fixed method of generating
      verifiably random curves and generated curves in <b>RFC 5639</b>{" "}
      <Link to="#rfc-5639">[2]</Link>, which matches the generated curves and
      seeds.
      <pre>
        <Pseudocode
          code={rfcCodeCommon}
      ...
      <pre>
        <Pseudocode
          code={rfcCodeCurves}
          options={{ lineNumber: true, noEnd: true, captionCount: 2 }}
        />
      </pre>
      ...
      <ol>
        <li id="brainpool-std">
          Manfred Lochter:{" "}
          <Link to="http://www.ecc-brainpool.org/download/Domain-parameters.pdf">
            ECC Brainpool Standard Curves and Curve Generation v. 1.0
          </Link>
          ,{" "}
          <Link to="https://web.archive.org/web/20170921224120/http://www.ecc-brainpool.org/download/Domain-parameters.pdf">
            [archive]
          </Link>
        </li>
        <li id="rfc-5639">
          Manfred Lochter, Johannes Merkle:{" "}
          <Link to="https://tools.ietf.org/html/rfc5639">
            Elliptic Curve Cryptography (ECC) Brainpool Standard Curves and
            Curve Generation (RFC5639)
          </Link>
        </li>
        <li id="bada55-brainpool">
          BADA55 Research Team:{" "}
          <Link to="https://bada55.cr.yp.to/brainpool.html">
            BADA55 Crypto - Brainpool curves
          </Link>
        </li>
      </ol>
    </Entry>
