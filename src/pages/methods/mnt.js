...
export default ({data, location}) => {
  ...
  return (
    <Entry data={data} location={location} title={"MNT"}>
      ...
      <Styled.p>
      A class of pairing-friendly curves with embedding degree <InlineMath>{`k \\in \\{3, 4, 6\\}`}</InlineMath>.
      Some curves generated via this method can be found in the <Link to={"/mnt/"}>MNT</Link> category.</Styled.p>
