  ...
  return (
    <Entry data={data} location={location} title={"MNT"}>
      ...
      <Styled.p>
        ...
        <InlineMath>{`k \\in \\{3, 4, 6\\}`}</InlineMath>. Some curves generated
        via this method can be found in the <Link to={"/mnt/"}>MNT</Link>{" "}
        category.
      </Styled.p>
      ...
      <ul>
        <li>
          ...
          <Link to="https://dspace.jaist.ac.jp/dspace/bitstream/10119/4432/1/73-48.pdf">
